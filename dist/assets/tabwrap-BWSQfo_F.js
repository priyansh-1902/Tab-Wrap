import{c as n,j as t}from"./client-DUeHcXHK.js";/* empty css                       */import{B as a}from"./Background-fbFSbEJB.js";function i(){const e=(Math.random()<.5?"magenta":"green")==="magenta"?{pillGradient:"linear-gradient(90deg, #ff2dbe 0%, #a259ff 100%)",circleGradient:"radial-gradient(circle, #ff2dbe 0%, transparent 70%)"}:{pillGradient:"linear-gradient(90deg, #39ff14 0%, #00ffa2 100%)",circleGradient:"radial-gradient(circle, #39ff14 0%, transparent 70%)"},r=()=>{window.location.href="tabwrapstats.html"};return t.jsxs(t.Fragment,{children:[t.jsx("style",{children:`
        html, body {
